...
- [#155](https://github.com/zipbul/gildash/pull/155) [`c8c6f5b`](https://github.com/zipbul/gildash/commit/c8c6f5b884c2bdb5017fe27e235c5d12a6bbe5c1) Thanks [@parkrevil](https://github.com/parkrevil)! - Distinguish default exports via `isDefault`.

  Previously an `export default` symbol was stored under its _local_ name (`delay`) with no
  ...
  - **`resolveSymbol("default", file)`** now resolves to the local default _definition_ (e.g.
...
- [#153](https://github.com/zipbul/gildash/pull/153) [`a2f8ee4`](https://github.com/zipbul/gildash/commit/a2f8ee41d8830f793009d8eb84ba6ca2409a43ec) Thanks [@parkrevil](https://github.com/parkrevil)! - Harden the language-plugin frontend support (Vue/Svelte):
...
- [#151](https://github.com/zipbul/gildash/pull/151) [`db99418`](https://github.com/zipbul/gildash/commit/db99418c51feb52b6ddaa0a0ceb6630f7ef02c91) Thanks [@parkrevil](https://github.com/parkrevil)! - Svelte support via `createSveltePlugin()` (optional peer `svelte` >= 5).
...
- [#149](https://github.com/zipbul/gildash/pull/149) [`a667484`](https://github.com/zipbul/gildash/commit/a66748409e33ff6d475aac95f4025446c1c98b24) Thanks [@parkrevil](https://github.com/parkrevil)! - Vue SFC support via a language-plugin architecture.
...
- [#147](https://github.com/zipbul/gildash/pull/147) [`ecfe328`](https://github.com/zipbul/gildash/commit/ecfe3287daabb2ff2d48f5971e3d2e0c45574b6e) Thanks [@parkrevil](https://github.com/parkrevil)! - React/JSX first-class support.
...
- [#145](https://github.com/zipbul/gildash/pull/145) [`7b83a71`](https://github.com/zipbul/gildash/commit/7b83a711f40604e31215944600ab533c343be251) Thanks [@parkrevil](https://github.com/parkrevil)! - Fix nested `package.json` files silently emptying main-project symbol/relation queries.
  ...
  unchanged): project identity is the package _name_, so two identically-named
...
- [#143](https://github.com/zipbul/gildash/pull/143) [`485df2c`](https://github.com/zipbul/gildash/commit/485df2cb26e55f1f348d02128284d87e4b5fc7e7) Thanks [@parkrevil](https://github.com/parkrevil)! - Add first-class monorepo (multi-tsconfig) support to the semantic layer.
...
- [#141](https://github.com/zipbul/gildash/pull/141) [`1146cf9`](https://github.com/zipbul/gildash/commit/1146cf9155364256d45b86643c50eb59a0fe9fc8) Thanks [@parkrevil](https://github.com/parkrevil)! - Fix `Gildash.open` hard-failing when a single file fails to parse.
...
- [#139](https://github.com/zipbul/gildash/pull/139) [`9429543`](https://github.com/zipbul/gildash/commit/942954315515949daa820cddc98d39fd004ee37f) Thanks [@parkrevil](https://github.com/parkrevil)! - Fix silent type loss for deeply-nested literals in the expression extractor.

  `convertExpression` capped recursion at depth 8 and returned `unresolvable` for
  _any_ node at/beyond it, so plain literals inside ordinary nested config — e.g.
...
- [#137](https://github.com/zipbul/gildash/pull/137) [`419db06`](https://github.com/zipbul/gildash/commit/419db0654c43fc4a914feacff8d94fb4ad5e438a) Thanks [@parkrevil](https://github.com/parkrevil)! - Internal hardening — no public API change.
...
- [#133](https://github.com/zipbul/gildash/pull/133) [`104d991`](https://github.com/zipbul/gildash/commit/104d991349c7d01190e285771fdf316f371a4bb6) Thanks [@parkrevil](https://github.com/parkrevil)! - feat(semantic): span-based type primitives — `getExpressionTypeAtSpan`, `isThenableAtSpan`, `getContextualCallReturnsAtSpan`
...
- [#131](https://github.com/zipbul/gildash/pull/131) [`83df9b4`](https://github.com/zipbul/gildash/commit/83df9b4ab7a52e47b9c5a7dcec6e33a356c41d11) Thanks [@parkrevil](https://github.com/parkrevil)! - feat(semantic): add `getStandaloneFileBindings` — isolated O(file) binding resolution
...
- [#129](https://github.com/zipbul/gildash/pull/129) [`445eda8`](https://github.com/zipbul/gildash/commit/445eda8d838a3b86297243feba30338b6b1b89c8) Thanks [@parkrevil](https://github.com/parkrevil)! - feat(semantic): batch ad-hoc binding resolution + public notify API
...
- [#127](https://github.com/zipbul/gildash/pull/127) [`8e4c439`](https://github.com/zipbul/gildash/commit/8e4c439cedb41f2b92bbaa7d9451c51f36a566c1) Thanks [@parkrevil](https://github.com/parkrevil)! - feat(semantic): add `getFileBindings` — single-pass file-level binding resolution
  ...
  that need _every_ binding in a file (declarations + their reads/writes) were
...
- [#125](https://github.com/zipbul/gildash/pull/125) [`e307060`](https://github.com/zipbul/gildash/commit/e30706028865e2712e2a38b855112dafbc460013) Thanks [@parkrevil](https://github.com/parkrevil)! - feat(semantic): add `getEnrichedReferences` — authoritative binding resolution with writeKind / isAmbient / enclosingScope

  The re-exported oxc-walker `ScopeTracker` tracks only lexical (block) scopes — it does not model JavaScript `var` hoisting, so a `var` declared in a block is not unified with reads in the enclosing function scope. Consumers that used it for _binding resolution_ (e.g. dataflow / dead-store detectors) got false positives.
...
- [#121](https://github.com/zipbul/gildash/pull/121) [`1c73175`](https://github.com/zipbul/gildash/commit/1c731753b1e96e93013ca830f16699e86d30727c) Thanks [@parkrevil](https://github.com/parkrevil)! - fix(ast): predicate narrowing collapsed to `never` for Function-interface variants
...
- [#119](https://github.com/zipbul/gildash/pull/119) [`ba67521`](https://github.com/zipbul/gildash/commit/ba67521ddfa7d390d250992eecab1c81981be27e) Thanks [@parkrevil](https://github.com/parkrevil)! - feat(ast): expose AST foundation primitives — type predicates and walk
...
- [#117](https://github.com/zipbul/gildash/pull/117) [`bccc348`](https://github.com/zipbul/gildash/commit/bccc3487b6e1734c518912eea4befba09281930b) Thanks [@parkrevil](https://github.com/parkrevil)! - feat: always preserve verbatim `specifier` on import / re-export / dynamic-import / require relations
  ...
  Note for query callers: relation lookups filtered on `specifier IS NOT NULL` (or equivalent) will return more rows than before — successfully resolved relations now also satisfy that predicate. If a consumer was using `specifier` presence as a _proxy for unresolution_, the correct signal is `dstFilePath === null` or `metaJson.isUnresolved === true`.
...
- [#115](https://github.com/zipbul/gildash/pull/115) [`3da2ab8`](https://github.com/zipbul/gildash/commit/3da2ab8a38049040d9b3ab26bd16c4f6bb485f94) Thanks [@parkrevil](https://github.com/parkrevil)! - refactor!: unify member keys under structured `key: SymbolKey` model (BREAKING)
