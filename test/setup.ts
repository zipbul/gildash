...
import * as realAnnotationExtractor from '../src/extractor/annotation-extractor';
...
const origAnnotationExtractor = { ...realAnnotationExtractor };
...
afterEach(() => {
  ...
  mock.module('../src/extractor/annotation-extractor', () => origAnnotationExtractor);
